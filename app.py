...
# --- MODERNIZOVANI PRILAGOĐENI CSS (PODRŽAVA DARK & LIGHT MOD) ---
st.markdown('''
    <style>
    ...
    /* Uklonjena fiksna bela pozadina da bi radilo u Dark modu */
    ...
    /* Dugmići sa gradijentom ostaju isti jer su tekstovi beli */
    .stButton > button {
